            ...
            <div class="m-2 p-2 bg-slate-100 rounded">
                <div class="space-y-8 divide-y divide-gray-200 w-1/2 mt-10">
                    <form method="POST" action="{{ route('admin.tables.update', $table->id) }}">
                        ...
                        <div class="sm:col-span-6 pt-2">
                            <label for="guest_number" class="block text-sm font-medium text-gray-700"> Jumlah Kursi
                            </label>
                            <div class="mt-1">
                        ...
                        <div class="sm:col-span-6 pt-2">
                            ...
                            <div class="mt-1">
                                <select id="status" name="status" class="form-multiselect block w-full mt-1 border-gray-400 rounded-md">
                        ...
                        <div class="sm:col-span-6 pt-2">
                            ...
                            <div class="mt-1">
                                <select id="location" name="location" class="form-multiselect block w-full mt-1 border-gray-400 rounded-md">
